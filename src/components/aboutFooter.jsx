        ...
        <div className="row justify-content-center">
          <div className="col-md-10">
            <div className="footer-top">
              <h4 className="text-white">Does our vision align with yours?</h4>
              <h6 className="text-white my-4">We love meeting like minded individuals and businesses. Let form a partnership to<br/>make africa one of  the best financially innovative continent in the world</h6>
